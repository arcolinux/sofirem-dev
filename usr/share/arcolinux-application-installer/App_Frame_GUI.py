...
def GUI(self, Gtk, vboxStack1, Functions, category, package_file):
    ...
    content.append("pack now") #Really, this can be any string, as long as it doesn't match the if statement below.
    ...
    for line in content:
        ...
        if line.startswith("  packages:"):
            ...
            description = line.strip("  description: ").strip().strip('"').strip("\n")
        else:
